...
function row(videoKey, posterKey, client, title, desc) {
  ...
  return `
    <div class="cc-row">
      ...
      <div class="cc-text">
        <span class="cc-client">${client}</span>
        <h2 class="cc-project-title">${title}</h2>
        <p class="cc-description">${desc}</p>
...
document.querySelector('#app').innerHTML = `
  ...
  <section class="px-4 pb-4 flex flex-col gap-[3px]">
    ...
    ${row('hype-hotel-mazda.mp4', null, 'MAZDA', 'Music in a Different Light',
    ...
    ${row('starlight-final-four.mp4', null, 'COCA-COLA', 'Starlight Final Four',
    ...
    ${row('grid-5-silent-light.mp4', null, 'WALTER ANDERSON MUSEUM OF ART', 'Silent Light',
    ...
    ${row('grid-4-nike-fuel-band.mp4', 'cc-nike-cover.jpg', 'NIKE', 'Fuel Band SXSW',
    ...
    ${row('cc-5-ai-lab.mp4', 'cc-5-ai-lab-cover.jpg', 'CMD', 'Immersion 360 AI Lab',
    ...
    ${row('cc-6-mazda-hype-hotel.mp4', null, 'MAZDA', 'SXSW Hype Hotel',
    ...
    ${row('cc-7-luminous-owls.mp4', 'cc-7-luminous-owls-cover.jpg', 'CMD', 'Luminous Owls',
    ...
    ${row('cc-8-work4hire.mp4', null, 'ASYMMETRIC', 'Work4Hire SXSW',
    ...
    ${row('grid-7-trampled.mp4', 'cc-trampled-cover.jpg', 'CMD', 'Trampled By Owls',
    ...
    ${row('grid-under-the-oaks.mp4', null, 'LAUREN RODGERS MUSEUM OF ART', 'Under the Oaks',
    ...
    ${row('cc-11-big-gigantic.mp4', null, 'BIG GIGANTIC', 'Big Gigantic',
    ...
    ${row('cc-12-cmd-fabrication.mp4', null, 'CMD', 'CMD Fabrication',
    ...
    ${row('spectrum-analyzer.mp4', 'cc-spectrum-cover.jpg', 'MAZDA', 'Spectrum Analyzer',
